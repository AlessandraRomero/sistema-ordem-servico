...
public class Peca implements Serializable {
	...
	@ManyToMany
	@JoinTable(name = "peca_ordemServico",
	joinColumns =  @JoinColumn (name = "peca_id" ),
    inverseJoinColumns = @JoinColumn(name = "ordemServico_id"))
	Set<OrdemDeServico> ordens = new HashSet<>();
	
	public Peca() {
		
	}

	public Peca(Long id, String descricao) {
		super();
		this.id = id;
